...
TEST_CASE("map_book", "[map_book]")
{
    ...
    SECTION("bids")
    {
        ...
        REQUIRE(itr->second.price() == 500);
        REQUIRE(itr->second.agg_qty() == 50);
        ++itr;
        REQUIRE(itr->second.price() == 400);
        REQUIRE(itr->second.agg_qty() == 40);
        ++itr;
        REQUIRE(itr->second.price() == 300);
        REQUIRE(itr->second.agg_qty() == 30);
        ++itr;
        REQUIRE(itr->second.price() == 200);
        REQUIRE(itr->second.agg_qty() == 20);
        ++itr;
        REQUIRE(itr->second.price() == 100);
        REQUIRE(itr->second.agg_qty() == 10);
    }
